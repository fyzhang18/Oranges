...
```{r}
#ACCURACY
#The average accuracy score on the test phase was 53% which is only sligh chance (50%) (need to check if 60% is stat sig above 50%). 
...
summary(fit3)
#result: #within a trial, pupil size increases for image type p = 0.009***
#no familiarity effect size increases p = 0.0263*
